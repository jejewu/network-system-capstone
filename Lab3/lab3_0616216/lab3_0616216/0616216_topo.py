...
def iptables(routers):
    print("[+] Setting iptables rules")
    routers['r1'].cmd('iptables -t nat -A PREROUTING -p tcp -d 140.113.0.40 --dport 80 -j DNAT --to-destination 192.168.1.66:8000')
